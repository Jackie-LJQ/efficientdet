...
parser.add_argument('--train-type', default='normal', type=str, metavar='TRAIN_TYPE', dest='train_type', 
                    help='advtrain for adversarial training')
parser.add_argument('--attacker', default='FGSM', type=str, help='attacker for adversarial training')
